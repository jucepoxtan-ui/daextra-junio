	...
	*/
	if(isset($_POST["registro"])){
		// Seleccionamos el id del user patrocinador
			$query = mysql_query("SELECT id FROM usuarios where usuario='".$_POST["patrocinador"]."'");$results = mysql_fetch_array($query); mysql_free_result($query);
			$id_patrocinador = $results['id'];
// Seleccionamos el numero del user patrocinador
			$query = mysql_query("SELECT numero_usuario FROM usuarios where id='".$id_patrocinador."'");$results = mysql_fetch_array($query); mysql_free_result($query);$numero_usuario = $results['numero_usuario'];
		// Obtenemos el usuario al que le deposita
			$query = mysql_query("SELECT COUNT(id) as contador_patrocinados FROM usuarios where id_user_deposita_a='".$numero_usuario."'");$results = mysql_fetch_array($query); mysql_free_result($query);
		...
		// Session
			...
			$_SESSION["numero_patrocinador"] = $numero_usuario;
	}
